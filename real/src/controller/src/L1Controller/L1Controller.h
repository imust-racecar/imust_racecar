...
private:
    ros::NodeHandle n_;
    ros::Subscriber path_sub, goal_sub, scan_sub, amcl_sub, odom_sub, can_run_circle_sub;
    ros::Publisher cmd_vel_pub, moveBase_pub, eta_pub, eta_point_pub, curvature_pub;
    ros::Timer control_timer, destination_timer;
    ...
    void destinationLoopCB(const ros::TimerEvent&);
    void canRunCircleCB(const geometry_msgs::Twist::ConstPtr& twistMsg);
